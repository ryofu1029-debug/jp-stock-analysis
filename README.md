...
日本企業約600社（TOPIX100 + Mid400 + Small上位）の株価をテクニカル指標と統計予測アンサンブルで分析するツール。すべて無料API（Yahoo Finance / yfinance + JPX公式リスト）のみ使用。
...
| ファイル | 役割 |
|---|---|
| `build_tickers.py` | JPX公式の上場銘柄一覧からTOPIX規模区分で銘柄を自動選定 → `data/tickers.csv` |
